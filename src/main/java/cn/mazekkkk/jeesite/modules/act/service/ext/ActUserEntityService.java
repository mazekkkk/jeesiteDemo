 ...
 */
package cn.mazekkkk.jeesite.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new cn.mazekkkk.jeesite.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new cn.mazekkkk.jeesite.modules.sys.entity.User(null, userId)))){
